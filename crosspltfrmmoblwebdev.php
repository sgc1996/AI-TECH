...
<body>
    ...
    <div class="container services job w-container">
        <?php print_r($message); ?>
        <h2 class="services-header _34">Cross-platform mobile Web Developer</h2>
        <div class="services-text-block">
            <strong class="bold-text"><em class="bluelead">Project<br></em></strong>Healthcare mobile application. Its primary goal is to provide access for patients to various educational materials, personalized clinical information, and to-do lists.<strong class="bold-text"><em class="bluelead">‍</em></strong><br>
        </div>
        <div class="services-text-block"><br>
            <strong class="bold-text"><em class="bluelead">Responsibilities</em></strong><br>As a Web Developer (all genders) you will be part of an engineering squad, working in cross-functional teams to develop and evolve the Application as a Service.<br>
        </div>
        <div class="services-text-block"><br>
            <strong class="bold-text"><em class="bluelead">Technologies</em></strong><br>npm, HTML, SCSS, Jest, Jasmine, Playwright, MongoDB, Typegoose, Prettier, Husky, ESLint, Stylelint, OAuth 2.0, API Management, CosmosDB, Azure Storage Account<br><br><strong class="bold-text"><em class="bluelead">Good to have<br></em></strong>state management (ngrx, ngxs, Redux)<br>
        </div>
        <div class="services-text-block"><br>
            <strong class="bold-text"><em class="bluelead">Requirements</em></strong><br>●&nbsp;&nbsp;&nbsp;&nbsp;Strong TypeScript and Angular experience<br>●&nbsp;&nbsp;&nbsp;&nbsp;Cross-platform mobile application (Ionic, Capacitor) development experience advantage<br>●&nbsp;&nbsp;&nbsp;&nbsp;Azure Functions experience<br>●&nbsp;&nbsp;&nbsp;&nbsp;Infrastructure as code (Terraform) knowledge<br>●&nbsp;&nbsp;&nbsp;&nbsp;Knowledge of Azure DevOps and Azure Pipelines services<br>●&nbsp;&nbsp;&nbsp;&nbsp;Good communication skills, high proficiency in English and Hungarian, German language skills are a plus<br>
        </div>
        <div class="services-text-block"><br>
