...
<body>
    ...
    <div class="container services job w-container">
        <?php print_r($message); ?>
        <h2 class="services-header _34">Cloud Developer</h2>
        <div class="services-text-block">
            <strong class="bold-text"><em class="bluelead">Project<br></em></strong>Replacement of a Manufacturing Execution System. Based on a green field with modern technologies.<strong class="bold-text"><em class="bluelead">‍</em></strong><br>
        </div><br>
        <div class="services-text-block">
            <strong class="bold-text"><em class="bluelead">Responsibilities</em></strong><br>As a .NET Developer (all genders) you will be part of an engineering squad, working in cross-functional teams to develop and evolve the System.<br>
        </div><br>
        <div class="services-text-block">
            <strong class="bold-text"><em class="bluelead">Technologies</em></strong><br>Angular, Micro Frontend, .NET/C#, AzureDevOps, Open Shift, Tekton<br>
        </div><br>
        <div class="services-text-block">
            <strong class="bold-text"><em class="bluelead">Requirements</em></strong><br>●&nbsp;&nbsp;&nbsp;&nbsp;Strong .NET / C# and Angular experience<br>●&nbsp;&nbsp;&nbsp;&nbsp;Knowledge of Azure DevOps and Azure Pipelines services<br>●&nbsp;&nbsp;&nbsp;&nbsp;Good communication skills, high proficiency in English and Hungarian, German language skills are a plus<br>
        </div><br>
        <div class="services-text-block">
