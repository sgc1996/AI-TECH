...
<head>
    <meta charset="utf-8">
    <title>A I TECHNOLOGIES (PVT) LTD - Sancharaka Udawa 2024</title>
    ...
    <meta property="og:url" content="https://aitech.lk/smm_su.php">
...
<!-- End of service dropdown -->
    ...
    <!-- Blog Detail Start -->
    <div class="mb-5 py-5">
    <h1 class="mb-4">Sancharaka Udawa 2024</h1>
    <p>The Sri Lanka Association of Inbound Tour Operators (SLAITO) is proud to announce the upcoming 'Sancharaka Udawa 2024' tourism products meet mart, scheduled to take place on May 17th and 18th, 2024. Hosted at the esteemed Sirimavo Bandaranaike Exhibition Halls at BMICH, this event marks the 11th edition of an eagerly anticipated exhibition.</p>
    <h4>Objective and Purpose</h4>
    <p>'Sancharaka Udawa 2024' continues its primary objective of bridging the gap between emerging entrepreneurs in the tourism industry and established stakeholders. By providing a platform for small and medium tourism service providers from various regions to showcase their offerings, the event facilitates essential connections with tour operators and the wider public, integrating them into the industry.</p>
    <p>Since its inception in 2011, this event has been the singular gathering of its kind in Sri Lanka, uniting a diverse array of industry professionals under one roof.</p>
