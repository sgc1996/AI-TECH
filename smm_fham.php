...
<meta name="description" content="Ai Technologies Pvt Ltd is thrilled to announce its partnership in handling the social media marketing for the  Food and Hospitality Asia Maldives (FHAM) 2024.">
<meta name="keywords" content="FHAM 2024, Food and Hospitality Asia Maldives Global Culinary Challenge and Exhibition, hospitality trade fair, South Asia, culinary arts, Maldives, international event, food industry, hospitality industry, culinary experts, resort operators, innovation, collaboration, economic impact, community impact, tourism, skill development, Ai Technologies, social media marketing, digital marketing">
<!--SEO FB-->
<meta property="og:title" content="FHAM 2024">
...
<meta property="og:url" content="https://aitech.lk/smm-events/smm_fham.php">
            ...
            <div class="row g-5 justify-content-center"> <!-- Added justify-content-center to center align the content -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="text-center"> <!-- Added text-center to center align the content -->
                        <a href="#" target="_blank"><img class="img-fluid w-100 rounded mb-5" src="img/smm/fham-1.jpg" alt=""></a>                  
                    </div>
                    <!-- Blog Detail End -->
                </div>
                ...
                <div class="col-lg-6">
                    <!-- Blog Detail Start -->
                    <div class="text-center"> <!-- Added text-center to center align the content -->
                        <a href="#" target="_blank"><img class="img-fluid w-100 rounded mb-5" src="img/smm/fham-2.jpg" alt=""></a>
                    </div>
                    <!-- Blog Detail End -->
                </div>
                <div class="col-lg-6">
                    <!-- Blog Detail Start -->
                    <div class="text-center"> <!-- Added text-center to center align the content -->
                        <a href="#" target="_blank"><img class="img-fluid w-100 rounded mb-5" src="img/smm/fham-3.jpg" alt=""></a>                  
                    </div>
                    <!-- Blog Detail End -->
                </div>
                ...
                <div class="col-lg-6">
                    <!-- Blog Detail Start -->
                    <div class="text-center"> <!-- Added text-center to center align the content -->
                        <a href="#" target="_blank"><img class="img-fluid w-100 rounded mb-5" src="img/smm/fham-4.jpg" alt=""></a>
                    </div>
                    <!-- Blog Detail End -->
                </div>
