...
<head>
    ...
    <meta property="og:url" content="https://aitech.lk/smm-events/smm_hs.php">
            ...
            <div class="row g-5 justify-content-center"> <!-- Added justify-content-center to center align the content -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="text-center"> <!-- Added text-center to center align the content -->
                        <a href="#" target="_blank"><img class="img-fluid w-100 rounded mb-5" src="img/smm/hs-1.jpg" alt=""></a>                  
                    </div>
                    <!-- Blog Detail End -->
                </div>
                ...
                <div class="col-lg-6">
                    <!-- Blog Detail Start -->
                    <div class="text-center"> <!-- Added text-center to center align the content -->
                        <a href="#" target="_blank"><img class="img-fluid w-100 rounded mb-5" src="img/smm/hs-3.jpg" alt=""></a>
                    </div>
                    <!-- Blog Detail End -->
                </div>
                <div class="col-lg-6">
                    <!-- Blog Detail Start -->
                    <div class="text-center"> <!-- Added text-center to center align the content -->
                        <a href="#" target="_blank"><img class="img-fluid w-100 rounded mb-5" src="img/smm/hs-2.jpg" alt=""></a>                  
                    </div>
                    <!-- Blog Detail End -->
                </div>
                ...
                <div class="col-lg-6">
                    <!-- Blog Detail Start -->
                    <div class="text-center"> <!-- Added text-center to center align the content -->
                        <a href="#" target="_blank"><img class="img-fluid w-100 rounded mb-5" src="img/smm/hs-4.jpg" alt=""></a>
                    </div>
                    <!-- Blog Detail End -->
                </div>
