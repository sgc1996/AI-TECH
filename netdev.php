...
<body>
    ...
    <div class="container services job w-container">
        <?php print_r($message); ?>
        <h2 class="services-header _34">.NET Developer</h2>
        <div class="services-text-block">
            <strong class="bold-text"><em class="bluelead">Project<br></em></strong>Manufacturing optical systems for lithographic applications. Within the project, the generic components are developed by the team in the form of a framework that allows for the efficient production of additional software packages.<strong class="bold-text"><em class="bluelead">‍</em></strong><br>
        </div><br>
        <div class="services-text-block">
            <strong class="bold-text"><em class="bluelead">Responsibilities</em></strong><br>As a .NET Developer (all genders) you will be part of an engineering squad, working in cross-functional teams to develop and evolve the Application as a Service.<br>
        </div>
        <div class="services-text-block">
            <strong class="bold-text"><em class="bluelead">Technologies</em></strong><br>Angular, .NET / C#<br>
        </div><br>
        <div class="services-text-block">
            <strong class="bold-text"><em class="bluelead">Requirements</em></strong><br>●&nbsp;&nbsp;&nbsp;&nbsp;Strong .NET / C# and Angular experience<br>●&nbsp;&nbsp;&nbsp;&nbsp;Good communication skills, high proficiency in English and Hungarian, German language skills are a plus<br>
        </div><br>
        <div class="services-text-block">
