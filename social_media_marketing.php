                ...
                <div class="row g-5">
                    <div class="col-lg-8">
                        ...
                        <div class="mb-5 py-5">
                            ...
                            <img class="img-fluid w-100 rounded mb-5" src="img/social_media_marketing.jpg" alt="">
                            ...
                            <!-- <div class="services-text-block">
                                <strong class="bold-text"><em class="bluelead">FAST & ACCURATE ONLINE DATA COLLECTION TO GAIN MEANINGFUL BUSINESS INSIGHTS</em></strong><br>
                            </div><br> -->
                            <div class="services-text-block">
                                Social media marketing is a powerful way for businesses of all sizes to reach prospects and customers. People discover, learn about, follow, and shop from brands on social media, so if you’re not on platforms like Facebook, Instagram, and LinkedIn, you’re missing out! Great marketing on social media can bring remarkable success to your business, creating devoted brand advocates and even driving leads and sales.<br>
                            </div><br>
                            <!-- <div class="services-text-block">
                                Our process involves excluding duplicates and redundant/obsolete information so that only relevant data is added to your database. We have developed automated tools to ensure a large volume of data is scraped from any website. Our fast and flexible data collection solutions have a faster turnaround to save the client’s time and reduce the cost of operations.<br>
                            </div><br>
                            <div class="services-text-block">
                                We employ conventional mail surveys, on-site paper surveys, interviews, online surveys using standard survey software like SurveyMonkey, Zoho Survey, Google Forms, etc. We have worked with different verticals like Healthcare, Insurance, Automobiles, Food Industry, Retail, and more for their web data collection requirements.<br>
                            </div><br> -->
                        </div>
                        <!-- Blog Detail End -->
                    </div>
            ...
            <div class="row gx-0">
                ...
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.3s">
                    <div class="bg-light shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                        ...
                        <div class="ps-4">
                            <h5 class="text-primary mb-0">Data Entry Operators</h5>
                            <h1 class="mb-0" data-toggle="counter-up">06</h1>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="text-center position-relative pb-3 mb-4 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">Our Flyer Design</h5>
            </div>
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.6s">
                <div class="d-flex align-items-center pt-5 pb-4 px-5">
                    <img class="img-fluid rounded" src="img/Flyer_01.jpg" style="width: 100%;">
                </div>
                <div class="d-flex align-items-center pt-5 pb-4 px-5">
                    <img class="img-fluid rounded" src="img/Flyer_02.jpg" style="width: 100%;">
                </div>
                <div class="d-flex align-items-center pt-5 pb-4 px-5">
                    <img class="img-fluid rounded" src="img/Flyer_03.jpg" style="width: 100%;">
                </div>
                <div class="d-flex align-items-center pt-5 pb-4 px-5">
                    <img class="img-fluid rounded" src="img/Flyer_04.jpg" style="width: 100%;">
                </div>
            </div>
        </div>
    </div>
